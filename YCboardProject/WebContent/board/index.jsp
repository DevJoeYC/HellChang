...
<table border="0" style="width:100%; height:100%;">
	...
	<tr>
		...
		{
			%>
			<a class="btn write" href="tindex.jsp?search_type=T&page=<%= curpage %>">앨범</a>
			<%
		}
		%>
			<%
		...
		<td valign="top">
			<table border="0" style="width:100%;">
				<tr>
					...
					<th class="list_title">제목</td>
					<th class="list_date">작성일</td>
					<th class="list_author">작성자</td>
					<th class="list_hit">조회수</td>							
				</tr>
