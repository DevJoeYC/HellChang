...
%>
	<td class="recomment" align="right">
		<%= comt_name %>
	</td>
	<td colspan="2"><textarea id="recmt_note" name="recmt_note" style="width:720px; height:100px;"></textarea></td>
	<td width="110px" align="center"><a class="btn rp" href="#" onclick="ReCommentOK(this,<%= comt_no %>);" >답글달기</a></td>
